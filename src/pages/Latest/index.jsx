          ...
          <div className="flex flex-col items-center justify-start max-w-[1246px] mx-auto md:px-5 w-full">
            ...
            >
              {allBooks
                ...
                .map((book) => {
                  const originalDate = new Date(book.created_at);
                  ...
                  return (
                    ...
                    >
                      <div className="h-[340px] md:ml-[0] ml-[5px] relative w-[99%]">
                        ...
                        />
                        <Text
                          className="absolute bg-deep_purple-A200 h-[41px] justify-center left-[0] pl-[18px] sm:pr-5 pr-[16px] py-1.5 rounded-br-[50px] rounded-tr-[50px] text-[18.67px] text-white-A700 top-[9%] w-[148px]"
                ...
                .map((book) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      <Button
                        className="cursor-pointer font-medium leading-[normal] min-w-[270px] mt-[75px] rounded-lg text-center text-xl"
                        shape="round"
                        color="deep_purple_A200"
                        size="sm"
                        variant="outline"
